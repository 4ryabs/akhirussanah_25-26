...
export default function AcaraPage() {
    ...
    return (
        <main className="relative w-full max-w-md h-[100dvh] mx-auto overflow-hidden bg-white shadow-2xl">
            ...
            <div className="absolute bottom-[36%] left-0 w-full flex flex-col items-center justify-center z-30 pointer-events-none space-y-4 animate-in-bottom-short">

                {/* Desain Timer (Sesuai Gambar) */}
                ...
                <button
                    ...
                    className={`pointer-events-auto mt-4 min-w-[240px] btn-hijau text-white font-bold text-[14px] py-3 px-6 rounded-full shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 ${poppins.className}`}
                >
                    {/* Icon Kalender bawaan SVG murni */}
